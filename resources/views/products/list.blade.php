...
<html lang="en">
  <head>
    ...
    <title>Laravel Office management</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-rbsA2VBKQhggwzxH7pPCaAqO46MgnOM80zW1RWuH61DGLwZJEdK2Kadq2F9CUG65" crossorigin="anonymous">
  </head>
  <body>

  <div class="bg-dark py-3">
    <h1 class="text-2xl text-white" >Laravel Office management</h1>
                ...
                <div class="input-group">
                  ...
                  <table class="table">
                    ...
                    <tr>
                      ...
                      <td>
                        @if($product ->image != "")
                        <img width="50" src="{{asset('uploads/products/'.$product)}}" alt="image">
                        @endif
                      </td>
                      <td>{{ $product->name }}</td>
                      <td>{{ $product->sku }}</td>
